...
const ICONS = {
  ...
  risk: '<path d="M3 15a9 9 0 0 1 18 0"/><path d="M12 15l4.6-3.3"/><circle cx="12" cy="15" r="1.4"/>',
  trends: '<path d="M3 17l6-6 4 4 8-8"/><path d="M17 7h4v4"/>',
...
const TABS = [
  ...
  { id: 'risk', title: 'Risk score', label: 'Score', render: renderRisk },
  { id: 'trends', title: 'Trends', label: 'Trends', render: renderTrends },
